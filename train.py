...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='', help='initial weights path')#../YOLOmodels/yolov4-p5.pt
    ...
    parser.add_argument('--name', default='myYOLOv4p5', help='renames results.txt to results_name.txt if supplied')
